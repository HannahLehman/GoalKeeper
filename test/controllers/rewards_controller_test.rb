...
class RewardsControllerTest < ActionController::TestCase
  ...
  test "should create reward" do
    assert_difference('Reward.count') do
      post :create, reward: { about: @reward.about, goal_id: @reward.goal_id, reward: @reward.reward, user_id: @reward.user_id }
    end
  ...
  test "should update reward" do
    patch :update, id: @reward, reward: { about: @reward.about, goal_id: @reward.goal_id, reward: @reward.reward, user_id: @reward.user_id }
    assert_redirected_to reward_path(assigns(:reward))
  end
